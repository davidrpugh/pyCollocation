...
class PolynomialSolver(solvers.SolverBase):
    ...
    def basis_derivative_factory(self, coef, domain, kind):
        """
    ...
    def basis_function_factory(self, coef, domain, kind):
        """
    ...
    def collocation_nodes(self, degree, domain, kind):
        ...
        basis_poly = self.basis_function_factory(basis_coefs, domain, kind)
